...
public struct Node
{
    ...
    public Node(Point position, int cost, int heuristic)
    {
        Cost = cost;
        Position = position;
        Heuristic = heuristic;
...
public class MinHeap
{
    ...
    public class DijikstraFinder
    {
        ...
        
        {
            ...
            var startNode = new Node(start, 0, ManhattanDistance(start, finish));
            ...
            while (!openSet.IsEmpty())
            {
                ...
                {
                    int newCost = distances[currentNode.Position] + 1;
                    ...
                    if (newCost < distances[neighbor])
                    {
                        ...
                        openSet.Add(new Node(neighbor, newCost, ManhattanDistance(neighbor, finish))); 
